...
public class Add_If_MinController implements Initializable {
...
//        }
        ...
        if (error){
            ...
            SendThing sendThing = udpClient.send(ticket,"add_if_min","",UDPClient.login);
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        check_button.setText(res.getString("addButton"));
