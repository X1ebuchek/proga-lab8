...
public class Computer {
    ...
    public static SendThing loop(String s) {
        ...
        Command registerCommand = new RegisterCommand(r);
        Command authCommand = new AuthorizationCommand(r);
        ...
        Invoker i = new Invoker(helpCommand, infoCommand, showCommand, addCommand, updateCommand,
                ...
                historyCommand, execute_scriptCommand, registerCommand, authCommand);
...
//        if (UDPClient.login.isEmpty() && !s.equals("reg") && !s.equals("auth")){
//            System.out.println("Вы не авторизованы");
//            System.out.println("Авторизируйтесь или зарегистрируйтесь");
//            System.out.println("Введите reg или auth");
//            return null;
//        }
//        if (!UDPClient.login.isEmpty() && (s.equals("reg") || s.equals("auth"))){
