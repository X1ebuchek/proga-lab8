...
//        }
        if (error){
            ...
            Event e;
            if (eventType.isEmpty() || eventType == null) e = new Event(id1, name1, description, null);
            ...
            SendThing sendThing = udpClient.send(ticket,"update",id.toString(),UDPClient.login);
    ...
    void insertValues(Ticket ticket){
        name_field.setText(ticket.getName());
        x_field.setText(String.valueOf(ticket.getX()));
        y_field.setText(String.valueOf(ticket.getY()));
        price_field.setText(String.valueOf(ticket.getPrice()));
        comment_field.setText(ticket.getComment());
        refundable_field.setValue(String.valueOf(ticket.isRefundable()));
        type_field.setValue(String.valueOf(ticket.getType()));
        name1_field.setText(ticket.getName1());
        description_field.setText(ticket.getDescription());
        eventType_field.setValue(String.valueOf(ticket.getEventType()));
    }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        check_button.setText(res.getString("updateButton"));
    }
}
